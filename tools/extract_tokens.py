...
class TokenExtractor:
    ...
    def find_faction_rules_pdf(self, team_name: str) -> Path | None:
        ...
        processed_dir = Path("layers/kt-app/processed") / team_name
    ...
    def _find_marker_guide_pdf(self, image_path: Path) -> Path:
        ...
        # PDF should be in layers/kt-app/processed/{team}/{team}-faction-rules.pdf
        ...
        if 'output_v2' in parts:
            ...
            if faction_idx + 1 < len(parts):
                ...
                # Look for PDF in layers/kt-app/processed/{team}/
                pdf_path = Path('layers/kt-app/processed') / team / f"{team}-faction-rules.pdf"
                if pdf_path.exists():
                    return pdf_path
