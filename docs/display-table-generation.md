...
- **Script**: (removed during cleanup; not currently wired into the pipeline)
...
This repo no longer includes a standalone display table generator script.

## When to Run

Display table generation is not currently generated by the pipeline.
