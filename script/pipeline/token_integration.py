    ...
    def embed_ready_tokens(
        ...
        *,
        ...
        for s in statuses:
            ...
            # Put the per-token infinite bags into the team bag so users can take
            # unlimited copies without manual duplication.
            token_objs = [t["bag"] for t in tokens_data]
            team_bag = bag_generator.generate_team_bag(s.team, token_objs, self.output_v2_dir)
            bag_save = {
                "SaveName": "",
                "Date": "",
                "VersionNumber": "",
