...
1. Create a folder with the team name: `script/config/backside/team/{team-name}/`
...
2. **Default backside** (`script/config/backside/default/`) - fallback
